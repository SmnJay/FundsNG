...
const page = () => {
  return (
    <div>
      ...
      <div className="mt-4 flex items-center justify-between rounded-md bg-signUp-pattern bg-leafGreen-20 text-white p-8">
      ...
      <div className="bg-white rounded-md mt-4">
        ...
        <div className="flex items-center justify-evenly p-8">
          <div className="space-y-2 text-center">
            <span className="bg-leafGreen-50 inline-block h-20 w-20 rounded-full"></span>
