    ...
    return (
        <div className='bg-[#F6F6F6]'>
            ...
            <main className='app-width py-6'>
                ...
                <section className="lg:grid lg:grid-cols-3 gap-6 max-lg:space-y-4 relative">
                    <section className="lg:col-span-2 bg-white rounded-b-lg">
                    ...
                    <aside className="w-full space-y-4 md:sticky md:top-4 md:self-start">
                        <div className="bg-white px-4 py-3 rounded-lg">
                            <div className="flex flex-col sm:flex-row gap-2 sm:items-center text-sm sm:justify-between mb-4">
                                <div className="">&#8358;600,000.00 <span className="font-thin text-[#888F87] pl-1">Donated</span></div>
                                <div className=""> <span className="font-thin text-[#888F87] pr-1">Our Goal</span>&#8358;600,000.00</div>
                            </div>
