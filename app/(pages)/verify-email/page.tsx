...
const VerifyEmail = () => {
    ...
    return (
        <form className="relative md:shadow-lg md:bg-white rounded-2xl px-4 py-8 md:p-8 w-auto md:min-w-[500px]" autoComplete="off">
            ...
            <p className="text-primary font-medium text-center text-xl leading-loose">Check your email</p>
            <p className="text-center text-[#929090] ">We sent you an email. Please, check to verify your acount.</p>

            <div>
                <Image src={'/images/email.png'} width={253} className='mx-auto' height={253} alt={'Envelope representing email sent to the mailbox'} />
            </div>
