...
const PopularCategories = () => {
    return (
        <div className="bg-white rounded-md mt-4 md:mt-8">
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 items-center gap-2 p-4">
                ...
                <Category
                    name='Housing'
                    donations='2k donations'
                    textColor='text-[#B1475B]'
                    bgColor='bg-[#F9E7F3]'
                    icon={
                        <svg width="51" height="51" viewBox="0 0 51 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_4713_8372)">
                                <path d="M25.5001 29.75C23.8094 29.75 22.1879 30.4216 20.9923 31.6172C19.7968 32.8127 19.1251 34.4342 19.1251 36.125V51.0553H31.8751V36.125C31.8751 34.4342 31.2035 32.8127 30.0079 31.6172C28.8124 30.4216 27.1909 29.75 25.5001 29.75Z" fill="#AA2C43" fillOpacity="0.87" />
                                <path d="M28.3433 1.77082C27.5628 1.06837 26.55 0.679687 25.5 0.679688C24.45 0.679688 23.4372 1.06837 22.6567 1.77082L0 22.1623V44.2623C0 46.0658 0.716426 47.7954 1.99167 49.0707C3.26692 50.3459 4.99653 51.0623 6.8 51.0623H14.875V36.1257C14.875 33.3078 15.9944 30.6053 17.987 28.6127C19.9796 26.6201 22.6821 25.5007 25.5 25.5007C28.3179 25.5007 31.0204 26.6201 33.013 28.6127C35.0056 30.6053 36.125 33.3078 36.125 36.1257V51.056H44.2C46.0035 51.056 47.7331 50.3395 49.0083 49.0643C50.2836 47.789 51 46.0594 51 44.256V22.1559L28.3433 1.77082Z" fill="#AA2C43" fillOpacity="0.87" />
                            </g>
                            <defs>
                ...
                <Category
                    name='Business'
                    donations='2k donations'
                    textColor='text-[#198F8F]'
                    bgColor='bg-[#EDFAF6]'
                    icon={
                        <svg width="52" height="51" viewBox="0 0 52 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_4713_8395)">
                ...
                <Category
                    name='Charity'
                    donations='2k donations'
                    textColor='text-[#F7A145]'
                    bgColor='bg-[#FDF6E2]'
                    icon={
                        <svg width="52" height="51" viewBox="0 0 52 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clipPath="url(#clip0_4713_8407)">
