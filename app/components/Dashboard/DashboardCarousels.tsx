                                ...
                                <div className="">
                                    <div className="flex items-center gap-2">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M9.49072 12.4102H10.6481L14.2721 13.9956C14.8287 14.2392 15.0847 14.8861 14.8454 15.4445V15.4445C14.6048 16.006 13.9546 16.266 13.3932 16.0254L12.3842 15.593" stroke="#4591A1" stroke-width="0.833333" stroke-linecap="round" stroke-linejoin="round" />
                                    ...
                                    <div className="flex items-center gap-2">
                                        <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g clip-path="url(#clip0_5082_10119)">
                                                <path d="M10.2056 12.4062H11.363L15.0673 14.0269C15.5794 14.251 15.815 14.8462 15.5947 15.3601L15.5254 15.5218C15.304 16.0384 14.7058 16.2777 14.1892 16.0563L13.0991 15.5891" stroke="#213502" stroke-width="0.763244" stroke-linecap="round" stroke-linejoin="round" />
